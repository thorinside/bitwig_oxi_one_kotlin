...
const val SYSEX_HEADER = "f0 00 21 5b 00 01 "
const val REMOTE_MODE_SYSEX_ACK: String = SYSEX_HEADER + "06 53 f7"
...
class OxiOneHardware(private val inputPort: MidiIn, private val outputPort: MidiOut) :
    ...
    private fun bitmapToHexString(image: BufferedImage): String {
        ...
        val hexString = StringBuilder(SYSEX_HEADER + "03 ")
    ...
    fun enterRemoteMode() {
        val sysexMessage = SYSEX_HEADER + "06 55 f7"
        outputPort.sendSysex(sysexMessage)
    }

    fun remoteModeAck() {
        val sysexMessage = SYSEX_HEADER + "06 53 f7"
        outputPort.sendSysex(sysexMessage)
    }

    fun exitRemoteMode() {
        val sysexMessage = SYSEX_HEADER + "00 f7"
        outputPort.sendSysex(sysexMessage)
    }
